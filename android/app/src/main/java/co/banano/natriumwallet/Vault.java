...
public class Vault {
    ...
    private static final String AUTOMATICALLY_KEYED_PREF_FILE_NAME = "co.raiblocksone.pilium.automaticallyKeyedPref";
    private static final String AUTOMATICALLY_KEYED_KEY_FILE_NAME = "co.raiblocksone.pilium.automaticallyKeyedKey";
    private static final String AUTOMATICALLY_KEYED_KEY_ALIAS = "co.raiblocksone.pilium.automaticallyKeyed";
