...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Kalium. Μόλις λάβετε BARaiBlocksOne, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 BARaiBlocksOne"),
    ...
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Kalium! Το καλύτερο πορτοφόλι για BARaiBlocksOne σε κινητά τηλέφωνα!"),
